...
public:
	...
	*/
	...
	their combination returns false. If the input array is smaller, then it is temporarily padded
	with zeros; otherwise, if the input array is of equal or greater length, the operation is performed up to the length 
	of the object's array.
	...
	*/
	...
	if both bits are false, their combination returns false. If the input array is smaller, then it is temporarily padded
	with zeros; otherwise, if the input array is of equal or greater length, the operation is performed up to the length 
	of the object's array.
	...
	*/
	...
	bits is true; otherwise, their combination returns false. If the input array is smaller, then it is temporarily padded
	with zeros; otherwise, if the input array is of equal or greater length, the operation is performed up to the length 
	of the object's array.
	\param in_array CBitArray that is to be used to perform the bitwise OR operation.
	\return Reference to this CBitArray object.
