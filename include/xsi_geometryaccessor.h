...
public:
	...
	*/
	...
	/*! Returns an array containing the \a turn-internal-edge offset for each polygon in the geometry.
	This offset is used by the tesselator to create a triangulation as if the polygon had
	been defined using its vertex [offset, offset+1, offset+2, ...] instead of [0,1,2,...]
	\retval out_array Array containing the turn-internal-edge offset for each polygon.
	\return CStatus::OK
	\since 8.0 (2010)
	*/
	...
	*/
	...
	are stored as a flat list and can be indexed into with the indices returned from, for example, CGeometryAccessor::GetVertexIndices,
	CGeometryAccessor::GetTriangleVertexIndices.
	...
	*/
	...
	/*! Returns an array of user motion property objects connected to the clusters of this geometry. This function is a more convenient
	alternative to using CGeometryAccessor::GetClusterProperties.
  	\return CRefArray Array of references to user motion properties.
	\sa CGeometryAccessor::GetClusterProperties, ClusterProperty
	*/
	CRefArray GetUserMotions() const;

	/*! Finds the user motion property object connected to the geometry which matches the specified name. This function is a more convenient
	alternative to using CGeometryAccessor::GetClusterProperty.
	\param in_nName The property name.
  	\return CRef A reference to the cluster property object.
	\sa CGeometryAccessor::GetClusterProperty, ClusterProperty
