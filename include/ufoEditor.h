 ...
 *
 * ufoEditorCreateStandardEditor():(NOT IMPLEMENTED IN Softimage )
 ...
 *								   ufoEditorRGBDraw
 *
 * ufoEditorDrawSubImage()		   (Softimage) Draw part of a raster on the viewer.   
 *
 ...
 *
 * ufoEditorForceUpdateUI():	   (NOT IMPLEMENTED IN Softimage )
 ...
 *	  (Softimage) Draw part of a raster on the viewer.  
 *
 *	  -	May	be called within ufoEditorMouseDown(), ufoEditorMouseUp(), 
 *		ufoEditorMouseDrag(), ufoEditorMousePosition(),	ufoEditorKeyEvent(), 
 *		or from	within any event function in the editor	GUI.
