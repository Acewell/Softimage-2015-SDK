...
/*! \class PointLocatorData xsi_pointlocatordata.h
	...
	by the following methods:
		...
		\li Geometry::GetRaycastIntersections
	...
	\sa Geometry, Geometry::GetClosestLocations, Geometry::GetClosestLocationsWithinRadius,
		Geometry::SetupPointLocatorQueries, Geometry::GetSurfacePointLocatorsFromPoints,
...
public:
	...
	*/
	...
	/*! Returns true if a given point locator is valid.  A point locator is invalid if, for instance, a call to
	Geometry::GetRaycastIntersections didn't find an intersection for a given ray.
	\param i The index of the point locator.
	\return True if the point locator is valid; false otherwise.
	\since 6.0
	*/
