...
/*! \class Argument xsi_argument.h
   \brief The Argument object represents an argument (or \a parameter) of a Softimage Command. For example,
   the \xl DeleteObj command takes 1 argument (\c InputObj).
