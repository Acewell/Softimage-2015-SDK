...
public:
	...
	*/
	...
	/*! Returns the polygon node used to start the triangle fan of the default triangulation of the polygon.
	This offset is controlled by applying the \xp turnedgeinpolygons TurnEdge operator \endxp.
	\return The offset between \c 0 and \c NbPoints-1
	\since 8.0 (2010)
	*/
