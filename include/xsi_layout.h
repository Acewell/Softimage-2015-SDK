...
/*! \class Layout xsi_layout.h
	\brief The Layout object represents an instance of a screen layout in Softimage and gives access to the
	views attached to that layout. The layout is read-only and cannot be edited or created with the SDK.
