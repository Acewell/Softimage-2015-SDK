 ...
 *
 * ufoEditorCreate():                   (NOT IMPLEMENTED IN Softimage )  create GUI & any user data for
 *                                      (NOT IMPLEMENTED IN Softimage )  process  editor
 * ufoEditorDelete():                   (NOT IMPLEMENTED IN Softimage )  destroy  GUI & any user data for
 *                                      (NOT IMPLEMENTED IN Softimage )  process  editor
 *
 * ufoEditorShowGui():                  (NOT IMPLEMENTED IN Softimage )  show GUI (i.e. manage pop-ups etc)
 * ufoEditorHideGui():                  (NOT IMPLEMENTED IN Softimage )  hide GUI (i.e. unmanage  pop-ups etc)
 * ufoEditorUpdateGui():                (NOT IMPLEMENTED IN Softimage )  update GUI to show parameter values
 *
 * ufoEditorBeginViewerEditing():       (Softimage) called when a process is being edited in a viewer,
 *                                      redraw and mouse callbacks can be expected to be called.
 *                                      A processor could be edited in multiple viewers at once
 * ufoEditorEndViewerEditing():         (Softimage) called when a process is no longer being edited in a viewer
 *
 ...
 *    (Softimage) called when a process is being edited in a viewer,
 *    redraw and mouse callbacks can be expected to be called.
 *    A processor could be edited in multiple viewers at once.
 ******************************************************************************/
 ...
 *    (Softimage) called when a process is no longer being edited in a viewer
 ******************************************************************************/
