...
namespace MATH {
	...
	/*! \defgroup MathConstants Math Constants
	...
	\section PI
	\code static const double PI(3.14159265358979323846);\endcode
	Represents the \c PI constant as a \c double.
	*/
	static const double PI(3.14159265358979323846);

	/*! \addtogroup MathConstants
	\section PI2
	\code static const float PI2((float)PI*2.0f);\endcode
	Represents the \c PI constant multiplied by \c 2 as a \c float.
	*/
	static const float PI2((float)PI*2.0f);

	/*! \addtogroup MathConstants
	\section Invert2PI
	\code static const float Invert2PI(0.5f/(float)PI);\endcode
	Represents the \c PI constant inverted as a \c float.
	*/
	static const float Invert2PI(0.5f/(float)PI);

	/*! \addtogroup MathConstants
	\section MilliEPS
	\code static const float MilliEPS(1.0e-03f);\endcode
	Represents <TT>0.001</TT> as a float.
	*/
	static const float MilliEPS(1.0e-03f);

	/*! \addtogroup MathConstants
	\section MicroEPS
	\code static const float MicroEPS(1.0e-06f);\endcode
	Represents <TT>0.000 001</TT> as a float.
	*/
	static const float MicroEPS(1.0e-06f);

	/*! \addtogroup MathConstants
	\section NanoEPS
	\code static const float NanoEPS(1.0e-09f);\endcode
	Represents <TT>0.000 000 001</TT> as a float.
	*/
	static const float NanoEPS(1.0e-09f);

	/*! \addtogroup MathConstants
	\section PicoEPS
	\code static const float PicoEPS(1.0e-012f);\endcode
	Represents <TT>0.000 000 000 001</TT> as a float.
	*/
	...
	*/
	...
	SICPPSDKDECL void MatToEuler( const CMatrix3f& in_mat, CVector3f& io_vct, const short in_order );
	SICPPSDKDECL void EulerToMat( const CVector3f& in_vct, CMatrix3f& out_mat, const short in_order );
	SICPPSDKDECL void EulerToQuat( const CVector3f& in_vct, CQuaternionf& out_quat, const short in_order);
};
