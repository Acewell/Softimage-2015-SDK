...
public:
	...
	*/
	...
	\param in_X			X coordinate on the image.
	\param in_Y			Y coordinate on the image.
	\retval out_Pixels	The color of the image at the given coordinate
	*/
	...
	\param in_X		X coordinate on the image.
	\param in_Y		Y coordinate on the image.
	\retval out_R	The red component value of the color of the image at the given coordinate
	\retval out_G	The green component value of the color of the image at the given coordinate
	\retval out_B	The blue component value of the color of the image at the given coordinate
	\retval out_A	The alpha component value of the color of the image at the given coordinate
	*/
