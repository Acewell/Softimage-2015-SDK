...
public:
	...
	*/
	...
	\param in_classification The classification of the custom parameter
	...
	*/
	...
	in any fashion.  An example use of an FCurve parameter can be found on the Bulge Operator (see \xp bulgeop \endxp).
	...
	\param in_scriptname Script name of the new parameter
	...
	*/
	...
	\param io_buffer Memory location
	\return CStatus::OK success
