...
converted to a CValue containing a CString. A VARIANT referring to a Softimage COM object is converted to a
%CValue containing the equivalent XSI::CRef object.  A VARIANT referencing a SAFEARRAY is converted to a
CValue containing a XSI::CValueArray. Some uncommon types of VARIANT are not supported, in which case
\c E_INVALIDARG is returned.
