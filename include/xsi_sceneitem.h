...
/*! \class SceneItem xsi_sceneitem.h
	...
	in Softimage from which all other scene objects derive.
...
public:
	...
	*/
	...
	\param in_preset Name of a shader preset to apply to object. The shader preset is optional. If no
		shader preset is supplied then a material is created with a default phong shader connected to
		the surface port.
	...
	*/
	...
	\param in_preset The filename or full path to a Preset file.
	\param in_bBranch True to apply property on the branch of object.
	\param in_name	 The name of the new Property object.
	\retval out_prop The new Property object.
	*/
	CStatus 	AddProperty
	(
		const CString&	in_preset,
	...
	*/
	...
	\param in_name The scripting name of the property.
	\retval out_prop The property retrieved.
	\return CStatus::OK success
	\return CStatus::Fail other failure
	*/
	CStatus		GetPropertyFromName
	(
		const CString&	in_name,
		Property&		out_prop
	);
	...
	\return CStatus::Fail other failure
	*/
	CStatus		GetLocalPropertyFromName
	(
		const CString&	in_name,
		Property&		out_prop
	);
