...
/*! \class Scene xsi_scene.h
	\brief The %Scene object represents a Softimage scene that is loaded in memory.
...
public:
	...
	*/
	...
	/*! Returns the scene's pass container. The pass container contains all the passes in
	the scene, along with scene global render options properties.
	\return The PassContainer object.
	\sa PassContainer SceneRenderProperty Scene::GetActivePass Scene::GetPasses Pass
	\sa \xl CreatePass \xl CreatePassWithPartition \xl GetCurrentPass \xl SetCurrentPass \xl DeleteCurrentPass
	\since 6.0
	*/
	...
	*/
	...
	\param in_csGUID The GUID of the object to retrieve
	...
	*/
	...
	("Scene.Sources.Image") containers.
	...
	*/
	...
	\return Array of references to the cameras.
	\sa Camera
	\since 12.0 (2014)
	*/
	...
	\return Array of file cache clips
	\since 12.0 (2014)
	*/
