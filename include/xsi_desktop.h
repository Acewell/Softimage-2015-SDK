...
/*! \class Desktop xsi_desktop.h
	\brief The %Desktop provides the services for creating and accessing UI objects in Softimage.
	\since 4.0
...
public:
	...
	*/
	...
	\warning Softimage will not function properly if you do not restore the controls hook.
	...
	*/
	...
	/*! Returns the platform-specific top Softimage window handle. On Windows, you must cast the return value
	to an \c HWND. On Linux, you get an \c X window.
	...
	*/
	...
	/*! Sets the default OpenGL context as current. Use this call if you need to initialize OpenGL resources
	which need to be shared with Softimage.
	\since 9.0 (2011)
	*/
	void SetDefaultOpenGLContext();

	/*! Explicitly dirties all active viewports and causes a refresh.
	\sa \xl Refresh, \xl SceneRefresh
	\since 9.0 (2011)
	*/
