...
/*! \class Camera xsi_camera.h
	\brief The Camera object represents a Softimage camera in a scene.

	You can create a Camera with X3DObject::AddCamera. A new camera always has its interest
	located at the origin of the scene's 3D world.
...
public:
	...
	*/
	...
	\param out_Left The left value.
	\param out_Right The right value.
	\param out_Bottom The bottom value.
	\param out_Top The top value.
	\return Whether the execution failed or not.
	\since 11.0 (2013)
	*/
