...
/*!
	\file SIBCQuaterniond.h
	\brief Defines the CSIBCQuaterniond class
	...
	public:
		...
		*/
		...
		/*! Sets the new quaternion's values to those given as the parameters.
			\param[in]	in_dW	The value for the W component of the quaternion.
			\param[in]	in_dX	The value for the X component of the quaternion.
			\param[in]	in_dY	The value for the Y component of the quaternion.
			\param[in]	in_dZ	The value for the Z component of the quaternion.
		...
		*/
		...
		/*! Sets the new quaternion's vector values (X, Y, Z) as the corresponding
			...
			\param[in]	in_vct	Vector containing values for the new quaternion's vector components.
		...
		*/
		...
		/*! Sets the new quaternion's values as their corresponding components in \p in_vct.
			\param[in]	in_vct	4D Vector containing component values for the new quaternion.
		...
		*/
		...
		/*! Determines whether this quaternion is a 'pure' quaternion. Pure quaternions
			...
			\retval	true if the quaternion is pure
		...
		*/
		...
		/*! Determines whether this quaternion is the identity quaternion (all components
			...
			\retval	true if the quaternion is the identity quaternion
			\retval	false otherwise
			\sa CSIBCQuaterniond::SetIdentity
		*/
		bool IsIdentity();
		...
		*/
		...
		/*! Sets the W (scalar) component of the quaternion.
			\param[in]	in_dW	New value for the W component of the quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
		...
		*/
		...
		/*! Sets the X component of the quaternion.
			\param[in]	in_dX	NeX value for the X component of the quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
		...
		*/
		...
		/*! Sets the Y component of the quaternion.
			\param[in]	in_dY	NeY value for the Y component of the quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
			\sa CSIBCQuaterniond::SetW
		...
		*/
		...
		/*! Sets the Z component of the quaternion.
			\param[in]	in_dZ	NeZ value for the Z component of the quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
			\sa CSIBCQuaterniond::SetW
		...
		*/
		...
		/*! Returns the quaternion values with a CSIBCVector4Dd.
			\param[out]	out_vct	Vector to receive the values of this quaternion.
		...
		*/
		...
		/*! Returns the quaternion values.
			\param[out]	out_dW	double to receive the W component of the quaternion.
			\param[out]	out_dX	double to receive the X component of the quaternion.
			\param[out]	out_dY	double to receive the Y component of the quaternion.
			\param[out]	out_dZ	double to receive the Z component of the quaternion.
			\sa CSIBCQuaterniond::Get
			\sa CSIBCQuaterniond::Set
		*/
		...
		/*! Sets the quaternion values.
			\param[in]	in_dW	New value for the W component of this quaternion.
			\param[in]	in_dX	New value for the X component of this quaternion.
			\param[in]	in_dY	New value for the Y component of this quaternion.
			\param[in]	in_dZ	New value for the Z component of this quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
		*/
		...
		/*! Sets this quaternion's components from the corresponding components of \p in_vct.
			\param[in]	in_vct	Vector containing new values for the quaternion's components.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
		*/
		...
		/*! Sets this quaternion's vector components from the corresponding components of
			...
			\param[in]	in_vct	Vector containing new values for the quaternion's vector components.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Set
			\sa CSIBCQuaterniond::Get
		*/
		...
		*/
		...
		/*! Determines whether each of the components of \p in_quat1 and \p in_quat2 are
			...
			\param[in]	in_quat1	The first quaternion for equality comparison.
			\param[in]	in_quat2	The second quaternion for equality comparison.
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #PICO_EPS.
			\retval	true if the quaternions are equal
			\retval	false otherwise
		...
		*/
		...
		/*! Determines whether each of the components of this quaternion and \p in_quat are
			...
			\param[in]	in_quat	Quaternion to compare equality with.
			\retval	true if the quaternions are exactly equal
			\retval	false otherwise
		...
		*/
		...
		/*! Determines whether any of the components of this quaternion and \p in_quat are
			...
			\param[in]	in_quat	Quaternion to compare inequality with.
			\retval	true if the quaternions are not equal
			\retval	false if they are exactly equal
			\sa CSIBCQuaterniond::operator==
			\sa CSIBCQuaterniond::AreAlmostEqual
		*/
		bool operator !=( const CSIBCQuaterniond& in_quat ) const;
		...
		*/
		...
		/*!	Sets this quaternion to the inverse of the unit quaternion \p in_quat.
			...
			to CSIBCQuaterniond& Conjugate( const CSIBCQuaterniond& in_quat ).
			\param[in]	in_quat	Quaternion whose inverse contains the new values for this
		...
		*/
		...
		/*!	Sets this quaternion to the conjugate of \p in_quat. A conjugate quaternion is
			...
			\param[in]	in_quat	Quaternion whose conjugate contains the new values for this
				quaternion's components.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Invert
			\sa CSIBCQuaterniond::Conjugate
		...
		*/
		...
		/*!	Adds \p in_quat to this quaternion.
			\param[in]	in_quat	Quaternion to add to this quaternion.
			\return	Reference to this quaternion.
		...
		*/
		...
		/*! Adds \p in_quat1 and \p in_quat2 and stores the result in this quaternion.
			\param[in]	in_quat1	First quaternion for addition.
			\param[in]	in_quat2	Second quaternion for addition.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Add
			\sa CSIBCQuaterniond::Sub
		*/
		...
		/*! Subtracts \p in_quat from this quaternion.
			\param[in]	in_quat	Quaternion to subtract from this quaternion.
			\return	Reference to this quaternion.
			\sa	CSIBCQuaterniond::Sub
			\sa	CSIBCQuaterniond::Add
		*/
		...
		/*! Subtracts \p in_quat2 from \p in_quat1 and stores the result in this quaternion.
			\param[in]	in_quat1	Quaternion for subtraction.
			\param[in]	in_quat2	Quaternion to subtract from \p in_quat1.
			\return	Reference to this quaternion.
			\sa	CSIBCQuaterniond::Sub
			\sa	CSIBCQuaterniond::Add
		*/
		...
		/*! Computes the right-multiplication of \p in_quat1 by \p in_quat2
			(<TT>in_quat1 * in_quat2</TT>), and stores the result in this quaternion.
			\param[in]	in_quat1	First quaternion for the multiplication (on the left).
			\param[in]	in_quat2	Second quaternion for the multiplication (on the right).
			\return	Reference to this quaternion.
			\sa	CSIBCQuaterniond::Mul
		*/
		CSIBCQuaterniond& Mul( const CSIBCQuaterniond& in_quat1, const CSIBCQuaterniond& in_quat2 );

		/*! Computes the right-multiplication of this quaternion by \p in_quat
			(<TT>this * in_quat</TT>), and stores the result in this quaternion.
			\param[in]	in_quat	Quaternion for the multiplication (on the right).
			\return	Reference to this quaternion.
			\sa	CSIBCQuaterniond::Mul
		*/
		...
		/*! Computes the right-multiplication of the pure quaternion represented by \p in_quatPure,
			and the quaternion \p in_quat (<TT>in_quatPure * in_quat</TT>), and stores the result in
			this quaternion.
			\param[in]	in_quatPure	Vector representing the vector components of a pure
		...
		*/
		...
		/*! Computes the right-multiplication of the quaternion \p in_quat and the pure quaternion
			represented by \p in_quatPure (<TT>in_quat * in_quatPure</TT>), and stores the result in
			this quaternion.
			\param[in]	in_quat	Quaternion for the multiplication (on the left).
			\param[in]	in_quatPure	Vector representing the vector components of a pure
				quaternion (W component is zero), for the multiplication (on the right).
			\return	Reference to this quaterion.
			\sa CSIBCQuaterniond::Mul
		*/
		...
		/*! Scales \p in_quat by a factor of \p in_dFactor, and stores the result in this quaternion.
			\param[in]	in_quat	Quaternion to scale.
			\param[in]	in_dFactor	Scaling factor for quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Mul
		*/
		...
		*/
		...
		/*! Scales this quaternion by a factor of \p in_dFactor.
			\param[in]	in_dFactor	Scaling factor to apply to this quaternion.
			\return	Reference to this quaternion.
			\sa CSIBCQuaterniond::Mul
		*/
		...
		/*! Computes the dot product of \p in_quat1 and \p in_quat2.
			\param[in]	in_quat1	First quaternion for the dot product.
			\param[in]	in_quat2	Second quaternion for the dot product.
			\return	The dot product of \p in_quat1 and \p in_quat2.
		*/
		...
		/*! Computes the spherical linear interpolation of two unit quaternions,
			...
			vectors is given by \p in_dU, in the range <TT>[0.0f, 1.0f]</TT>. The
			interpolated quaternion is stored in this quaternion.

			\param[in]	in_quatStart	Unit quaternion for the starting interpolation point.
			\param[in]	in_quatEnd		Unit quaternion for the ending interpolation end.
			\param[in]	in_dU			Interpolation point between \p in_quatStart and \p in_quatEnd.
				Must be in the range <TT>[0.0f, 1.0f]</TT>.
			\return	Reference to this quaternion.
		*/
		...
		/*! Not implemented yet. */
		CSIBCQuaterniond& BisectSlerp( const CSIBCQuaterniond& in_quatStart,/*!< n/a */
							const CSIBCQuaterniond& in_quatEnd /*!< n/a */);

		// DoubleSlerp     | Fast slerp for u=2.0
		/*! Not implemented yet.*/
		CSIBCQuaterniond& DoubleSlerp( const CSIBCQuaterniond& in_quatStart,/*!< n/a */
							const CSIBCQuaterniond& in_quatEnd /*!< n/a */);

		// Ln              | Compute ln(q) (for a unit quaternion). Result is a pure quaternion.
		/*! Not implemented yet.*/
		bool Ln( CSIBCQuaterniond& out_quat /*!< n/a */);

		// Exp             | Compute e^q (for a pure quaternion). Result is a unit quaternion.
		/*! Not implemented yet.*/
		bool Exp( CSIBCQuaterniond& out_quat /*!< n/a */);

		// Squad           | Quadrangle interpolation of quaternions, using three spherical
		//					 linear interpolations.
		/*! Not implemented yet.*/
		CSIBCQuaterniond& Squad( const CSIBCQuaterniond& in_quatB0,/*!< n/a */
					  const CSIBCQuaterniond& in_quatS1,/*!< n/a */
					  const CSIBCQuaterniond& in_quatS2,/*!< n/a */
					  const CSIBCQuaterniond& in_quatB3,/*!< n/a */
					  const double in_dU,/*!< n/a */
					  const double in_dT /*!< n/a */);
