...
/*!
	\file SIBCVector.h
	\brief Defines the CSIBCVector2D, CSIBCVector3D, and CSIBCVector4D classes
...
// Macros
//***************************************************************************************
#define SIBCVECTOR_EPS 0.00001f 	/*!< Floating-point comparison error factor */
	...
	public:
		...
		*/
		...
		/*! Copy constructor.
			...
			\param[in]	i_vVector	Vector to use for new vector's component values.
		*/
		...
		/*! Constructor.
			...
			\param[in]	i_fX	The value for the X component of the new vector.
			\param[in]	i_fY	The value for the Y component of the new vector.
		*/
		...
		/*! Determines whether this vector and \p i_vVector are equal to each other, within a
			threshhold value given by \c i_fEpsilon.
			\param[in]	i_vVector	Vector to compare equality with.
			\param[in]	i_fEpsilon	Error range for floating-point comparison.
			\retval SI_Bool::TRUE if the vectors are equal
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are orthogonal (at 90 degrees to
			...
			\param[in]	i_vVector	The vector to compare orthogonality with.
			\retval SI_Bool::TRUE if the vectors are orthogonal
			\retval SI_Bool::FALSE otherwise
		...
		*/
		...
		/*! Determines whether all of the components of this vector are zero. This function
			...
			\retval SI_Bool::TRUE if all of the vector's components are zero
			\retval SI_Bool::FALSE otherwise
			\sa	CSIBCVector2D::IsAlmostEqualTo
			\sa	CSIBCVector2D::IsNull
		*/
		...
		/*! Computes the dot product between this vector and \p i_vVector.
			\param[in]	i_vVector	Vector to dot-product with this vector.
		...
		*/
		...
		/*! Returns the distance between this vector and \p i_vVector.
			\param[in]	i_vVector	Vector to determine distance from.
			\return	Distance from this vector to \p i_vVector.
		...
		*/
		...
		/*! Returns the value and index of the maximum component of this vector.
			\param[out]	o_nIndex	Pointer to an SI_Int to hold the value of the index that had the
				maximum component (0 == X, 1 == Y).
			\return	The value of the maximum component of this vector.
		...
		*/
		...
		/*! Returns the value and index of the minimum component of this vector.
			\param[out]	o_nIndex	Pointer to an SI_Int to hold the value of the index that had the
				maximum component (<TT>0 == X, 1 == Y</TT>).
			\return	The value of the maximum component of this vector.
			\sa	CSIBCVector2D::Get
		*/
		...
		/*! Returns the values of the vector components.
			\param[out]	o_fX	Pointer to an SI_Float to receive the value of the X component.
			\param[out]	o_fY	Pointer to an SI_Float to receive the value of the Y component.
		...
		*/
		...
		/*! Sets the values of the X and Y components of this vector.
			\param[in]	i_fX	The new value for the X component of this vector.
			\param[in]	i_fY	The new value for the Y component of this vector.
		...
		*/
		...
		/*! Sets the value of the X component of this vector.
			\param[in]	i_fX	The new value of the X component of this vector.
			\sa CSIBCVector2D::SetY
			\sa CSIBCVector2D::Set
			\sa CSIBCVector2D::GetX
		*/
		...
		/*! Sets the value of the Y component of this vector.
			\param[in]	i_fY	The new value of the Y component of this vector.
			\sa CSIBCVector2D::SetX
			\sa CSIBCVector2D::Set
			\sa CSIBCVector2D::GetY
		*/
		...
		/*! Normalizes the vector to a length of one. If the vector is null, then it is
			initialized to (<TT>1.0f, 0.0f</TT>).
			\return	Reference to this vector.
		...
		*/
		...
		/*! Sets this vector to null. (Components equal \c 0.0f).
			\return Reference to this vector.
			\sa CSIBCVector2D::IsNull
			\sa CSIBCVector2D::Set
		*/
		...
		/*! Sets the length of this vector to be \p i_fLength. If the vector is null
			...
			\param[in]	i_fLength	New length of the vector.
			\return	Reference to this vector.
			\sa CSIBCVector2D::GetLength
			\sa CSIBCVector2D::Set
		*/
		...
		*/
		...
		/*! Adds this vector to \p i_vVector, and stores the result in this vector.
			\param[in]	i_vVector	The vector to add to this vector.
			\return	Reference to this vector.
		...
		*/
		CSIBCVector2D& Sub(const CSIBCVector2D& /*!< The vector to subtract from this vector. */);

		/*!	Scales all components of this vector by \p i_fScale.
			\param[in]	i_fScale	The amount to scale each of the components of this vector by.
			\return	Reference to this vector.
			\sa CSIBCVector2D::operator*
			\sa CSIBCVector2D::SetLength
		*/
		...
		/*! Multiplies each component in this vector by its corresponding component in \p i_vVector.
			...
			\param[in]	i_vVector	Vector to multiply components with this vector.
			\return	Reference to this vector
		...
		*/
		...
		/*! Divides each component in this vector by its corresponding component in \p i_vVector.
			The result is stored in this vector.
			\param[in]	i_vVector	Vector to divide components with this vector.
			\return Reference to this vector.
			\sa CSIBCVector2D::operator/
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are inequal. Note that this function does
			not use any floating-point comparison error, thus the two vectors must be exactly the
			same for a SI_Bool::FALSE return value.
			\param[in]	i_vVector	Vector to compare inequality with.
			\retval SI_Bool::TRUE if the vectors are not equal
			\retval SI_Bool::FALSE otherwise
			\sa	CSIBCVector2D::IsAlmostEqualTo
			\sa CSIBCVector2D::operator==
		*/
		...
		/*! Computes the vector addition between this vector and \p i_vVector.
			\param[in]	i_vVector	The vector to add this vector with.
		...
		*/
		...
		/*! Computes the vector subtraction of \p i_vVector from this vector.
			\param[in]	i_vVector	The vector to subtract from this vector.
		...
		*/
		...
		/*! Multiplies each component of this vector by \p i_fFloat.
			\param[in]	i_fFloat	The amount to scale each component of this vector by.
...
/*! \brief General purpose 3D vector class.
	...
	public:
		...
		*/
		...
		/*! Constructor.
			...
			\param[in]	i_fX	The value for the X component of the new vector.
			\param[in]	i_fY	The value for the Y component of the new vector.
			\param[in]	i_fZ	The value for the Z component of the new vector.
		*/
		...
		/*! Determines whether this vector and \p i_vVector are equal to each other,
			within a threshold value given by \c i_fEpsilon.
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are orthogonal (at 90 degrees to
			...
			\param[in]	i_vVector	The vector to compare orthogonality with.
			\retval SI_Bool::TRUE if the vectors are orthogonal
			\retval SI_Bool::TRUEFALSE otherwise
		...
		*/
		...
		/*! Returns the value and index of the maximum component of this vector.
			\param[out]	o_nIndex	Pointer to an SI_Int to hold the value of the index that
				had the maximum component (<TT>0 == X, 1 == Y, 2 == Z</TT>).
			\return	The value of the maximum component of this vector.
		...
		*/
		...
		/*! Returns the values of the vector components.
			\param[out]	o_fX	Pointer to an SI_Float to receive the value of the X component.
			\param[out]	o_fY	Pointer to an SI_Float to receive the value of the Y component.
			\param[out]	o_fZ	Pointer to an SI_Float to receive the value of the Z component.
		...
		*/
		...
		/*!	Returns the W component of this vector. This function is used for compatibility
			with CSIBCVector4D objects, and always returns \c 1.0f.
		...
		*/
		...
		/*! Sets the values of the X, Y and Z components of this vector.
			\param[in]	i_fX	The new value for the X component of this vector.
			\param[in]	i_fY	The new value for the Y component of this vector.
			\param[in]	i_fZ	The new value for the Z component of this vector.
			\return	Reference to this vector.
			\sa CSIBCVector3D::Get
		*/
		...
		/*! Normalizes the vector to a length of one. If the vector is null, then
			it is initialized to (<TT>1.0f, 0.0f, 0.0f</TT>).
			\return	Reference to this vector.
		...
		*/
		...
		/*! Sets this vector to be the cross product of this vector and \p i_vVector.
			\param[in]	i_vVector	The vector to cross this vector with.
			\return	Reference to this vector.
		...
		*/
		...
		/*! Scales all components of this vector by \p i_fScale, and stores the result in \p o_vDest.
			\param[out]	o_vDest		Vector to receive the scaled vector.
			\param[in]	i_fScale	The amount to scale each component of this vector.
			\return	Reference to this vector.
		*/
		...
		*/
		...
		/*! Computes the cross product between this vector and \p i_vVector. The operation is as
			follows: <TT>Vout = Vthis x Vin</TT>.
			\param[in]	i_vVector	Vector to find the cross product with.
			\return	The result of the cross product.
			\sa	CSIBCVector3D::SetCross
		*/
		CSIBCVector3D  CrossProduct( const CSIBCVector3D& i_vVector)  const;

		/*! Scales the components of this vector by \p i_fScale, and adds the result to
			the \p io_vDest vector. The result is stored in \p io_vDest.
			\param[in,out]	io_vDest	Vector to add to this scale vector. Holds the results of this operation.
			\param[in]	i_fScale	The amount to scale each component of this vector (before addition).
			\sa CSIBCVector3D::Add
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are equal.
			\note This function does not use any floating-point comparison error, thus the two
				vectors must be exactly the same.
			\param[in]	i_vVector	Vector to compare equality with.
			\retval SI_Bool::TRUE if the vectors are equal
			\retval SI_Bool::FALSE otherwise
			\sa	CSIBCVector3D::IsAlmostEqualTo
		...
		*/
		...
		/*! Determines whether this vector and \p i_vVector are not equal.
			\note This function does not use any floating-point comparison error, thus the two
				vectors must be exactly the same for a FALSE return value.
			\param[in]	i_vVector	Vector to compare inequality with.
			\retval SI_Bool::TRUE if the vectors are not equal
			\retval SI_Bool::FALSE otherwise
			\sa	CSIBCVector3D::IsAlmostEqualTo
		...
		*/
		...
		/*! Computes the vector resulting from adding a constant value, \p i_fFloat, to
			...
			\param[in]	i_fFloat	The amount to add to each component of this vector.
			\return	The result of the addition.
			\sa CSIBCVector3D::Add
			\sa CSIBCVector3D::operator+(const CSIBCVector3D&)
			\sa CSIBCVector3D::operator-(const CSIBCVector3D&)
		...
		*/
		...
		/*! Computes the vector resulting from subtracting a constant value, \p i_fFloat, from
			each component of this vector.
			\param[in]	i_fFloat	The amount to subtract from each component of this vector.
			\return	The result of the subtraction.
			\sa CSIBCVector3D::Sub
			\sa CSIBCVector3D::operator-(const CSIBCVector3D&)
			\sa CSIBCVector3D::operator+(const SI_Float&)
...
/*! \brief General purpuse 4D vector class.
	...
	public:
		...
		*/
		...
		/*! Constructor.
			...
			\param[in]	i_fY	The value for the Y component of the new vector.
			\param[in]	i_fZ	The value for the Z component of the new vector.
			\param[in]	i_fW	The value for the W component of the new vector.
		*/
		...
		/*! Constructor.
			...
			\param[in]	i_vVct	The vector containing the X, Y and Z components to use for the new vector.
			\param[in]	i_fW	The W value for the new vector (defaults to 1.0f).
		*/
		...
		/*! Determines whether this vector and \p i_vVector are equal to each other, within the
			threshhold value given by \c i_fEpsilon.
			\param[in]	i_vVector	Vector to compare equality with.
			\param[in]	i_fEpsilon	Error range for floating-point comparison.
			\retval SI_Bool::TRUE if the vectors are equal
		...
		*/
		...
		/*! Returns the value and index of the maximum component of this vector.
			\param[out]	o_nIndex	Pointer to an SI_Int to hold the value of the index that had the
				maximum component (<TT>0 == X</TT>, <TT>1 == Y</TT>, <TT>2 == Z</TT>, <TT>3 == W</TT>).
			\return	The value of the maximum component of this vector.
		...
		*/
		...
		/*! Returns the values of the vector components.
			...
			\param[out]	o_fY	Pointer to an SI_Float to receive the value of the Y component.
			\param[out]	o_fZ	Pointer to an SI_Float to receive the value of the Z component.
			\param[out]	o_fW	Pointer to an SI_Float to receive the value of the W component.
		...
		*/
		...
		/*! Sets the values of the X, Y, Z and W components of this vector.
			...
			\param[in]	i_fY	The new value for the Y component of this vector.
			\param[in]	i_fZ	The new value for the Z component of this vector.
			\param[in]	i_fW	The new value for the W component of this vector.
			\return	Reference to this vector.
			\sa CSIBCVector4D::Get
			\sa CSIBCVector4D::operator=
		*/
		...
		/*! Normalizes the vector to a length of one. If the vector is null, then it is
			initialized to (<TT>1.0f, 0.0f, 0.0f, 0.0f</TT>).
			\return	Reference to this vector.
		...
		*/
		...
		/*! Sets this vector to be equal to \p i_vVector.
			\param[in]	i_vVector	The vector to copy data from.
			\return	Reference to this vector.
			\sa CSIBCVector4D::Set
		*/
