...
/*!
	\file SIBCVectorwd.h
	\brief Defines the CSIBCVectorwd class
...
/*! \brief General purpose 3D vector class, with implicit W component.
	...
	public:
		...
		*/
		...
		/*! Returns the value of the component specified by \p in_nIndex.
			\param[in]	in_iIndex	Index of the component value to get (<TT>0 == X, 1 == Y, 2 == Z, 3 == W</TT>).
		...
		*/
		...
		/*! Sets the component given by \p in_nIndex to \p in_dVal.
			\param[in]	in_nIndex	The index of the component to set (<TT>0 == X, 1 == Y, 2 == Z, 3 == W</TT>).
		...
		*/
		...
		/*! Determines whether all corresponding components of this vector and
			...
			\param[in]	in_vct	Vector for equality comparison.
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #PICO_EPS.
		...
		*/
		...
		/*! Subtracts \p in_vct from this vector. The W components are not subtracted,
			...
			\param[in]	in_vct1	Vector to subtract from this vector.
			\return	Reference to this vector.
			\sa CSIBCVectorwd::Sub
			\sa CSIBCVectorwd::Add
		*/
		...
		*/
		...
		/*! Multiplies each component of this vector, except W, by \p in_dFactor. The
			...
			\param[in]	in_vct	Factor to multiply the components of this vector by.
			\return	Reference to this vector.
		...
		*/
		...
		/*!	Divides each component of this vector, except W, by \p in_dFactor.
			The result is stored in this vector.
			\param[in]	in_vct1	Factor to divide the components of this vector by.
			\return	Reference to this vector.
			\sa CSIBCVectorwd::Div
			\sa CSIBCVectorwd::Mul
			\sa CSIBCVectorwd::DivComp
		...
		*/
		...
		// 					  plane as v1 and v2.
		/*! Not implemented yet. */
		bool SetOrthogonal ( const CSIBCVectorwd& in_vct1,/*!< n/a */
							 const CSIBCVectorwd& in_vct2 /*!< n/a */);

		// SetOrthoProj 	| Same as SetOrthogonal, but the resulting
		//					  vector is the projection of v2.
		/*! Not implemented yet. */
		bool SetOrthoProj  ( const CSIBCVectorwd& in_vct1,/*!< n/a */
							 const CSIBCVectorwd& in_vct2 /*!< n/a */);

		// AreOrthogonal	| Verify if two vectors are orthogonal.
		/*! Not implemented yet. */
		friend bool AreOrthogonal ( const CSIBCVectorwd& in_vct1,/*!< n/a */
									const CSIBCVectorwd& in_vct2,/*!< n/a */
									const double in_dEpsilon = PICO_EPS /*!< n/a */);

		// SetProjection	| Project this vector onto another vector.
		/*! Not implemented yet. */
		CSIBCVectorwd& SetProjection ( const CSIBCVectorwd& in_vct /*!< n/a */);

		// SetMirror 		| Compute this=2*v2 - v1.
		/*! Not implemented yet. */
		CSIBCVectorwd& SetMirror(	const CSIBCVectorwd& in_vct1,/*!< n/a */
									const CSIBCVectorwd& in_vct2 /*!< n/a */);

		/*! Not implemented yet. */
		CSIBCVectorwd& BsplinePositionInterpolate ( const CSIBCVectorwd& in_vct1,/*!< n/a */
											const CSIBCVectorwd& in_vct2,/*!< n/a */
											const CSIBCVectorwd& in_vct3,/*!< n/a */
											const CSIBCVectorwd& in_vct4,/*!< n/a */
											const double in_dT /*!< n/a */);


		// Combine			| Compute this=s1*v1 + s2*v2.
		/*! Not implemented yet. */
		 CSIBCVectorwd& Combine(	const CSIBCVectorwd& in_vct1,/*!< n/a */ const double in_dS1,/*!< n/a */
									const CSIBCVectorwd& in_vct2, /*!< n/a */const double in_dS2 /*!< n/a */);

		// SetBounds		| Readjust boundaries (min and max) to contain a given point.
		/*! Not implemented yet. */
		 void SetBounds		( const CSIBCVectorwd& in_pnt,/*!< n/a */
							  CSIBCVectorwd& io_min,/*!< n/a */
							  CSIBCVectorwd& io_max /*!< n/a */);

		/*! Not implemented yet. */
		 friend double GetVctAngle	(	const CSIBCVectorwd& in_vct1,/*!< n/a */
										const CSIBCVectorwd& in_vct2,/*!< n/a */
										const bool in_bIsSigned = false /*!< n/a */);

		// GetPntAngle	| Compute angle (signed or not) between three points.
		/*! Not implemented yet. */
		friend double GetPntAngle(	const CSIBCVectorwd& in_pnt1,/*!< n/a */
									const CSIBCVectorwd& in_pnt2,/*!< n/a */
									const CSIBCVectorwd& in_pnt3,/*!< n/a */
									const bool in_bIsSigned = false /*!< n/a */);

		// GetVctCosAngle	| Compute cosinus of angle between two vectors.
		/*! Not implemented yet. */
		  friend double GetVctCosAngle( const CSIBCVectorwd& in_vct1,/*!< n/a */
										const CSIBCVectorwd& in_vct2 /*!< n/a */);

		// GetPntCosAngle	| Compute cosinus of angle between three points.
		/*! Not implemented yet. */
		friend double GetPntCosAngle(	const CSIBCVectorwd& in_pnt1,/*!< n/a */
										const CSIBCVectorwd& in_pnt2,/*!< n/a */
										const CSIBCVectorwd& in_pnt3 /*!< n/a */);

		// ArePntCollinear | Verify if three points are collinear.
		/*! Not implemented yet. */
		friend bool ArePntCollinear(	const CSIBCVectorwd& in_pnt1,/*!< n/a */
										const CSIBCVectorwd& in_pnt2,/*!< n/a */
										const CSIBCVectorwd& in_pnt3,/*!< n/a */
										const double in_dEpsilon = PICO_EPS /*!< n/a */);
		...
		/*! Not implemented yet. */
		friend bool AreVctCoplanar (	const CSIBCVectorwd& in_vct1,/*!< n/a */
										const CSIBCVectorwd& in_vct2,/*!< n/a */
										const CSIBCVectorwd& in_vct3,/*!< n/a */
										const double in_dEpsilon = PICO_EPS /*!< n/a */);
		...
		/*! Not implemented yet. */
		friend bool ArePntCoplanar(	const CSIBCVectorwd& in_pnt1,/*!< n/a */
									const CSIBCVectorwd& in_pnt2,/*!< n/a */
									const CSIBCVectorwd& in_pnt3,/*!< n/a */
									const CSIBCVectorwd& in_pnt4,/*!< n/a */
									const double in_dEpsilon = PICO_EPS /*!< n/a */);
