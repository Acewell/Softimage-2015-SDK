...
/*!
	...
	\brief Defines the CSIBCVector3Dd class
	...
	public:
		...
		*/
		...
		/*! Constructor.
			...
			\param[in]	in_dXYZ	Array containing the X, Y and Z values for the new vector.
		*/
		...
		*/
		...
		/*! Returns an array containing the X, Y and Z components of the vector. Note that
			...
			\return Array containing the X, Y and Z components of this vector.
		...
		*/
		...
		/*! Returns the value of the component specified by \p in_nIndex.
			\param[in]	in_nIndex	Index of the component value to get (0 == X, 1 == Y, 2 == Z).
		...
		*/
		...
		/*! Returns the values of the X, Y and Z components of this vector.
		...
		*/
		...
		/*!	Returns the value of largest component of the vector.
			...
			\return	The value (or absolute value if \p in_bInAbs is true) of the
		...
		*/
		...
		/*! Returns the index of the largest component of the vector.
			\param[in]	in_bInAbs	true if comparisons should be made with absolute values,
					false if comparisons should be made without absolute values. Defaults
					to true.
			\return	Index of the largest component of the vector (<TT>0 == X, 1 == Y, 2 == Z</TT>).
			\sa CSIBCVector3Dd::GetMaxComponent
			\sa CSIBCVector3Dd::GetIndexOfMinComponent
		*/
		...
		/*! Returns the index of the smallest component of the vector.
			\param[in]	in_bInAbs	true if comparisons should be made with absolute values,
					false if comparisons should be made without absolute values. Defaults
					to true.
			\return	Index of the smallest component of the vector (<TT>0 == X, 1 == Y, 2 == Z</TT>).
			\sa CSIBCVector3Dd::GetMinComponent
			\sa CSIBCVector3Dd::GetIndexOfMaxComponent
		*/
		...
		*/
		...
		/*! Sets the component given by \p in_nIndex to \p in_dVal.
			\param[in]	in_nIndex	The index of the component to set (<TT>0 == X, 1 == Y, 2 == Z</TT>).
		...
		*/
		CSIBCVector3Dd&	SetMinimal (
									 const CSIBCVector3Dd &,	/*!< Vector containing minimal component values.*/
									 bool in_bInAbs = true		/*!< true if comparisons are done with absolute values,
																	 false if comparisons are done without absolute values. Defaults to true. */
									);
		...
		*/
		...
		/*! Computes the cross product between this vector and \p in_vct (this x \p in_vct).
			The result is stored in this vector
			\param[in]	in_vct	Vector to cross with this vector (on the left).
			\return	Reference to this vector.
		...
		*/
		...
		/*! Computes the cross product between \p in_vct1 and \p in_vct2 (\p in_vct1 x \p in_vct2).
			The result is stored in this vector.
			\param[in]	in_vct1	Vector to cross with this vector (on the left).
			\param[in]	in_vct2	Another vector
			\return	Reference to this vector.
			\sa CSIBCVector3Dd::GetDot
			\sa CSIBCVector3Dd::SetCross
		*/
		...
		/*! Computes the vector that is orthogonal to \p in_vct1, and in the same plane as
			...
			\param[in]	in_vct1	Vector that the new vector should be orthogonal to.
			\param[in]	in_vct2	Another vector, with \p in_vct1 that forms a plane in which
					the new vector should lie in.
			\retval true if the orthogonal vector could be calculated
			\retval false if \p in_vct1 and \p in_vct2 are colinear, in which case this vector contains
					the null vector.
		...
		*/
		...
		/*! Computes the vector that is orthogonal to \p in_vct1, and in the same plane as
			...
			\param[in]	in_vct1	Vector taht the new vector should be orthogonal to.
			\param[in]	in_vct2	Another vector, with \p in_vct1 that forms a plane in which
					the new vector should lie in. The result is then projected onto this vector.
			\retval true if the orthogonal projected vector could be calculated
			\retval false if \p in_vct1 and \p in_vct2 are colinear, in which case this vector contains
					the null vector.
		...
		*/
		...
		/*! Determines whether two vectors \p in_vct1 and \p in_vct2 are orthogonal to each other.
			...
			\param[in]	in_vct1	First vector for orthogonality comparison.
			\param[in]	in_vct2	Second vector for orthogonality comparison.
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #PICO_EPS.
			\retval true if the vectors are orthogonal
			\retval false otherwise
			\sa CSIBCVector3Dd::SetOrthogonal
			\sa CSIBCVector3Dd::SetOrthoProj
			\sa CSIBCVector3Dd::GetOrthogonalBasis
		*/
		...
		/*! Projects this vector onto \p in_vct. The projected vector is stored in this vector.
			...
			\retval false if the input vector is the null vector, in which case this vector keeps
				its original value.
			\sa CSIBCVector3Dd::SetOrthoProj
		*/
		...
		/*! Determines whether \p in_vct1 and \p in_vct2 are parallel vectors. Since this method
			...
			equality comparison.
			\param[in]	in_vct1	The first vector in the parallelism comparison.
			\param[in]	in_vct2	The second vector in the parallelism comparison.
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #PICO_EPS.
		*/
		...
		*/
		...
		/*! Computes two vectors \p out_vct2 and \p out_vct3, which together with the input
			...
			\param[in]	in_vct1		Vector to compute the orthogonal basis from.
			\param[out]	out_vct2	Receives an orthogonal basis vector.
			\param[out]	out_vct3	Receives an orthogonal basis vector.
		...
		*/
		...
		/*! Computes two vectors \p out_vct2 and \p out_vct3, which together with the input
			...
			\param[in,out]	io_vct1		Vector to compute the orthonormal vector from. Normalized if not
					already normalized.
			\param[out]	out_vct2	Receives an orthonormal basis vector.
			\param[out]	out_vct3	Receives an orthonormal basis vector.
			\sa CSIBCVector3Dd::GetOrthogonalBasis
			\sa CSIBCVector3Dd::SetOrthogonal
			\sa CSIBCVector3Dd::SetOrthoProj
		*/
		...
		*/
		...
		/*! Computes the mean of the vector components of the vectors in the array \p in_vct.
			The result is stored in this vector.
			\param[in]	in_vct		Array of vectors (\p in_nbVct LONG) to calculate the mean of.
			\param[in]	in_nbVct	Number of vectors in the \p in_vct array.
			\return Reference to this vector.
		...
		*/
		...
		/*! Computes the angle between the vectors defined by \p in_pntOrigin to \p in_pnt1,
			...
			\param[in]	in_pntOrigin	Origin point for the two vectors.
			\param[in]	in_pnt1			End point of the first vector.
			\param[in]	in_pnt2			End point of the second vector.
			\return	Angle (in radians) between the two vectors. In the range <TT>[0.0f, #M_PI]</TT>.
		...
		*/
		...
		/*! Computes the angle between the vectors defined by \p in_pntOrigin to \p in_pnt1,
			...
			\param[in]	in_pnt1			End point of the first vector.
			\param[in]	in_pnt2			End point of the second vector.
			\return	Angle (in radians) between the two vectors. In the range <TT>[-#M_PI, #M_PI]</TT>.
		...
		*/
		...
		/*! Computes the cosine of the angle between the vectors defined by \p in_pntOrigin
			...
			\param[in]	in_pnt1			End point of the first vector.
			\param[in]	in_pnt2			End point of the second vector.
			\return	Cosine of the angle between the two vectors. In the range <TT>[-1.0f, 1.0f]</TT>.
			\sa CSIBCVector3Dd::GetPntsAngle
		...
		*/
		...
		/*!	Computes the angle between the vectors \p in_vct1 and \p in_vct2.
			...
			\param[in]	in_vct1		First vector.
			\param[in]	in_vct2		Second vector.
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #PICO_EPS.
			\return	Angle (in radians) between the two vectors. In the range <TT>[0.0f, #M_PI]</TT>.
			\sa CSIBCVector3Dd::GetPntsAngle
			\sa CSIBCVector3Dd::Get2DPntsAngleSigned
		...
		*/
		...
		/*! Computes the cosine of the angle between the vectors \p in_vct1 and \p in_vct2.
			\param[in]	in_vct1		First vector.
			\param[in]	in_vct2		Second vector.
			\param[in]	in_dEpsilon	Tolerance (defaults #PICO_EPS)
			\return	Cosine of the angle between the two vectors. In the range <TT>[-1.0f, 1.0f]</TT>.
			\sa CSIBCVector3Dd::GetPntsCosAngle
			\sa CSIBCVector3Dd::GetPntsAngle
			\sa CSIBCVector3Dd::Get2DPntsAngleSigned
		...
		*/
		...
		/*!	Determines which 'side' of the vector formed between the points \p in_pntOrigin and
			...
			\param[in]	in_pntOrigin	Staring point of the vector.
			\param[in]	in_pntTip		Ending point of the vector.
		...
		*/
		...
		/*! Calculates the area of the triangle with the verticies \p in_rPoint0,
			...
			\param[in]	in_rPoint0	First vertex of the triangle.
			\param[in]	in_rPoint1	Second vertex of the triangle.
			\param[in]	in_rPoint2	Third vertex of the triangle.
		*/
		...
		/*! Not implemented yet */
		void SetBounds( const CSIBCVector3Dd& in_pnt, /*!< n/a */CSIBCVector3Dd& io_min, /*!< n/a */CSIBCVector3Dd& io_max /*!< n/a */);

		// Combine		| Compute this=s1*v1 + s2*v2.
		/*! Not implemented yet */
		CSIBCVector3Dd& Combine( const CSIBCVector3Dd& in_vct1,/*!< n/a */ const double in_dS1,/*!< n/a */
			const CSIBCVector3Dd& in_vct2, /*!< n/a */const double in_dS2 /*!< n/a */);
		...
		/*! Not implemented yet. */
		CSIBCVector3Dd& BsplinePositionInterpolate( const CSIBCVector3Dd& in_vct1,/*!< n/a */
									const CSIBCVector3Dd& in_vct2,/*!< n/a */ const CSIBCVector3Dd& in_vct3,/*!< n/a */
									const CSIBCVector3Dd& in_vct4, /*!< n/a */const double in_dT /*!< n/a */);

		// BsplineVectorInterpolate | Interpolates a BSpline vector between four 3D vectors.
		/*! Not implemented yet. */
		CSIBCVector3Dd& BsplineVectorInterpolate( const CSIBCVector3Dd& in_vct1,/*!< n/a */
									const CSIBCVector3Dd& in_vct2,/*!< n/a */ const CSIBCVector3Dd& in_vct3,/*!< n/a */
									const CSIBCVector3Dd& in_vct4, /*!< n/a */const double in_dT /*!< n/a */);

		// ArePntsCollinear	| Verify if three points are collinear.
		/*! Not implemented yet. */
		friend bool ArePntsCollinear( const CSIBCVector3Dd& in_pnt1,/*!< n/a */
										const CSIBCVector3Dd& in_pnt2,/*!< n/a */
										const CSIBCVector3Dd& in_pnt3,/*!< n/a */
										const double in_dEpsilon = PICO_EPS /*!< n/a */);

		// AreVctsCoplanar	| Verify if two vectors are coplanar.
		/*! Not implemented yet. */
		friend bool AreVctsCoplanar ( const CSIBCVector3Dd& in_vct1,/*!< n/a */
										const CSIBCVector3Dd& in_vct2,/*!< n/a */
										const CSIBCVector3Dd& in_vct3,/*!< n/a */
										const double in_dEpsilon = PICO_EPS /*!< n/a */);

		// ArePntsCoplanar	| Verify if three points are coplanar.
		/*! Not implemented yet. */
		friend bool ArePntsCoplanar ( const CSIBCVector3Dd& in_pnt1,/*!< n/a */
										const CSIBCVector3Dd& in_pnt2,/*!< n/a */
										const CSIBCVector3Dd& in_pnt3,/*!< n/a */
										const CSIBCVector3Dd& in_pnt4,/*!< n/a */
										const double in_dEpsilon = PICO_EPS /*!< n/a */);
