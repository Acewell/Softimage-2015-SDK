...
/*!
	...
	\brief Defines the CSIBCMatrix44d class
	...
	public:
		...
		*/
		...
		/*! Sets all elements of the matrix by passing in a 4x4 array.
			\param[in]	in_dArray	4x4 array of double values, containing the new values for all
					the matrix elements.
			\return	Reference to this matrix.
			\sa CSIBCMatrix44d::Set
			\sa CSIBCMatrix44d::SetRow
		...
		*/
		...
		/*! Sets all elements of the matrix by passing in a pointer to a 4x4 array.
			\param[in]	in_dPtr	4x4 array of double values, containing the new values for all
					the matrix elements.
			\return	Reference to this matrix.
			\sa CSIBCMatrix44d::Set
			\sa CSIBCMatrix44d::SetRow
		...
		*/
		...
		/*! Computes the determinant of the 3x3 matrix formed by removing row \c in_nRow, and
			column \c in_nCol from this matrix.
			\param[in]	in_nRow	The row to remove from this matrix.
			\param[in]	in_nCol	The column to remove from this matrix.
		...
		*/
		...
		/*! Not implemented yet */
		CSIBCMatrix44d& Symmetry( CSIBCMatrix44d& in_mat /*!< n/a */) const;

		// Sets this matrix to its symmetrical.
		/*! Not implemented yet */
		CSIBCMatrix44d& Symmetry( void ) const;

		// Sets this matrix to the adjoint of the input matrix.
		/*! Not implemented yet */
		CSIBCMatrix44d& Adjoint( CSIBCMatrix44d& in_mat /*!< n/a */) const;
		...
		/*! Not implemented yet */
		void SetOuterProduct( const CSIBCVector4Dd& in_vct1/*!< n/a */, const CSIBCVector4Dd& in_vct2 /*!< n/a */);
