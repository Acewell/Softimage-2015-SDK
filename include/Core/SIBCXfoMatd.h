...
/*!
	\file SIBCXfoMatd.h
	\brief Defines the CSIBCXfoMatd class
...
/*!	\brief Class representing a 4x4 transformation matrix.
	...
	public:
		...
		*/
		...
		/*! Constructor.
			...
			\param[in]	in_vct3	The vector to use for the fourth row (or column) of the matrix.
		...
		*/
		...
		/*! Constructor.
			...
			\param[in]	in_dA03	The value for the element in row 1, column 4.
			...
			\param[in]	in_dA13	The value for the element in row 2, column 4.
			...
			\param[in]	in_dA23	The value for the element in row 3, column 4.
			\param[in]	in_dA30	The value for the element in row 4, column 1.
			\param[in]	in_dA31	The value for the element in row 4, column 2.
			\param[in]	in_dA32	The value for the element in row 4, column 3.
			\param[in]	in_dA33	The value for the element in row 4, column 4.
		*/
		CSIBCXfoMatd(
		...
		*/
		...
		/*!	Returns a pointer to the 4X4 array containing the data for this matrix. Note
			...
			\return	Pointer to the 4X4 array containing the data for this matrix.
			\sa CSIBCXfoMatd::Get
		*/
		...
		*/
		...
		/*! Sets all elements of the matrix.
			\param[in]	in_dVal	4x4 array of double values, containing the new values for all
				the matrix elements.
			\return	Reference to this matrix.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
		...
		*/
		...
		/*! Sets the top-left submatrix of this matrix.
			\param[in]	in_dVal	3x3 array of double values, containing the new values for the
		...
		*/
		...
		/*!	Sets all elements of the top-left submatrix of this matrix to those
			...
			\param[in]	in_mat	Matrix to copy top-left submatrix element value from.
			\return	Reference to this matrix.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
			\sa CSIBCXfoMatd::SetCol
		...
		*/
		...
		/*! Sets the transformation matrix to be a pure rotation, defined by \p in_mat.
			\param[in]	in_mat	Rotation to set this transformation matrix to.
			\return	Reference to this matrix.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
			\sa CSIBCXfoMatd::SetCol
		...
		*/
		...
		/*!	Sets the transformation matrix to be a pure rotation, defined by the transpose
			of \p in_mat.
			\param[in]	in_mat	Rotation transpose to set this transformation matrix to.
			\return	Reference to this matrix.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
			\sa CSIBCXfoMatd::SetCol
		...
		*/
		...
		/*!	Sets all elements in a row of the matrix.
			...
			\param[in]	in_dA3	Value for the element in the fourth column of the row.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
			\sa CSIBCXfoMatd::SetCol
			\sa CSIBCXfoMatd::Get
		...
		*/
		...
		/*!	Sets all elements in a column of the matrix.
			...
			\param[in]	in_dA3	Value for the element in the fourth row of the column.
			\sa CSIBCXfoMatd::Set
			\sa CSIBCXfoMatd::SetRow
			\sa CSIBCXfoMatd::SetCol
			\sa CSIBCXfoMatd::Get
		...
		*/
		...
		/*! Determines whether all corresponding elements of the matricies \p in_mat1 and
			...
			\param[in]	in_dEpsilon	Floating-point comparison error range. Defaults to #HEXA_EPS.
			\retval true if the matricies are equal
		...
		*/
		...
		/*! Determines whether all corresponding elements of this matrix and \p in_mat are
			...
			\retval true if the matricies are exactly equal
			\retval false otherwise
		...
		*/
		...
		/*! Determines whether any corresponding elements of this matrix and \p in_mat are
			...
			\retval true if the matricies differ in any element
			\retval false otherwise
			\sa CSIBCXfoMatd::AreAlmostEqual
			\sa CSIBCXfoMatd::operator==
		*/
		...
		*/
		...
		/*! Computes the matrix multiplication of two matricies (\p in_mat1 * \p in_mat2) and stores the
			result in this matrix.
			\param[in]	in_xfomat	The tranformation matrix in the multiplication (on the left).
			\param[in]	in_rotmat	The pure rotation matrix in the multiplication (on the right).
			\return	Reference to this matrix.
			\sa	CSIBCXfoMatd::Mul
			\sa CSIBCXfoMatd::MulTransByReg
		*/
		...
		/*! Computes the matrix multiplication of two matricies (\p in_mat1 * \p in_mat2) and stores the
			result in this matrix.
			\param[in]	in_rotmat	The pure rotation matrix in the multiplication (on the left).
			\param[in]	in_xfomat	The tranformation matrix in the multiplication (on the right).
			\return	Reference to this matrix.
			\sa	CSIBCXfoMatd::Mul
			\sa CSIBCXfoMatd::MulTransByReg
		*/
		...
		/*! Computes the matrix multiplication of the transpose of \p in_mat1 and \p in_mat2
			...
			\param[in]	in_rotmat	The first matrix in the multiplication (on the left), to be transposed
				before multiplication.
			\param[in]	in_xfomat	The second matrix in the multiplication (on the right).
			\return	Reference to this matrix.
			\sa	CSIBCXfoMatd::Mul
		...
		*/
		...
		/*! Computes the determines of the top-left 3x3 submatrix of this matrix.
			\return	The determinant of the top-left 3x3 submatrix.
		...
		*/
		...
		/*!	Gets the translation contained in this matrix.
			\param[out]	out_vctTrs	Receives the translation in the X, Y and Z directions.
		...
		*/
		...
		/*!	Sets the translation contained in this matrix.
			\param[in]	in_vctTrs	Vector containing the translations in the X, Y and Z directions.
			\return	Reference to this matrix.
		...
		*/
		...
		/*!	Adds a translation to the translation in this matrix.
			\param[in]	in_vctTrs	Vector containing the translations to add in the X, Y and Z directions.
			\return Reference to this matrix.
			\sa CSIBCXfoMatd::GetTranslation
			\sa CSIBCXfoMatd::SetTranslation
		*/
		...
		/*!	Gets the rotation matrix contained in this matrix as a rotation matrix.
			\param[out]	out_matRot	Receives the rotation matrix.
		...
		*/
		...
		/*!	Gets the rotation matrix contained in this matrix as a rotation object.
			\param[out]	out_rot	Receives the rotation object.
		...
		*/
		...
		/*! Sets the rotation contained in this matrix.
			\param[in]	in_matRot	Rotation matrix containing the rotation to set for this matrix.
			\return	Reference to this matrix.
			\sa CSIBCXfoMatd::GetRotation
			\sa CSIBCXfoMatd::AddRotation
		*/
		...
		/*!	Adds a rotation to the rotation in this matrix.
			\param[in]	in_matRot	Rotation matrix containing the rotation to add.
			\return Reference to this matrix.
			\sa CSIBCXfoMatd::GetRotation
			\sa CSIBCXfoMatd::SetRotation
		*/
		...
		/*! Returns the scaling of this matrix.
			\param[out]	out_vctScl	Receives the scaling components in the X, Y and Z directions.
		...
		*/
		...
		/*! Sets the scaling of this matrix.
			\param[in]	in_vctScl		Vector containing the scaling in the X, Y and Z directions.
			\return	Reference to this matrix.
		...
		*/
		...
		/*! Adds scaling to this matrix.
			\param[in]	in_vctScl		Vector containing the scaling to add in the X, Y and Z directions.
			\param[in]	in_bPreScaling	Whether the scaling operations should be applied before or after
			...
			\return	Reference to this matirx.
			\sa CSIBCXfoMatd::GetScaling
			\sa CSIBCXfoMatd::SetScaling
		*/
		...
		/*!	Sets the scaling and rotation for this transformation matrix. Note that it is faster to
			...
			\param[in]	in_vctScl	Vector containing the scaling in the X, Y and Z directions.
			\param[in]	in_rot		Rotation object containing the rotation for this matrix.
			\sa CSIBCXfoMatd::SetScaling
			\sa CSIBCXfoMatd::SetRotation
		...
		*/
		...
		/*! Returns the scaling and rotation for this transformation matrix. Note that it is faster to
			use this method, than a combination of CSIBCXfoMatd::GetScaling, and CSIBCXfoMatd::GetRotation.
			\param[out]	out_vctScl	Receives the scaling components in the X, Y and Z directions.
			\param[out]	out_rot		Receives the rotation object for this matrix.
			\sa CSIBCXfoMatd::GetScaling
			\sa CSIBCXfoMatd::GetRotation
		...
		*/
		...
		/*! Returns the affine tranformation represented by this transformation matrix.
			\param[out]	out_sclRot	Receives the affine scaling/rotation matrix associated with this
				transformation matrix.
			\param[out]	out_matSRT	Receives the affine transformation matrix associated with this
				transformation matrix.
		*/
		...
		/*! A smart matrix decomposition method to handle negative scaling
			\param[out]	out_Scale	Receives the scale components
				respected.
			\param[out]	out_Rotate	Receives the rotation components.
				respected.
			\param[out]	out_Trans	Receives the translation components.
		*/
