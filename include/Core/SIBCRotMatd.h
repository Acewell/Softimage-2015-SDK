...
/*!
	\file SIBCRotMatd.h
	\brief Defines the CSIBCRotMatd class
...
/*!	\brief Representation of a 3X3 rotation matrix.
	...
	public:
		...
		*/
		...
		/*! Sets all elements of the matrix.
			\param[in]	in_dVal	3x3 array of double values, containing the new values for all the matrix elements.
			\return	Reference to this matrix.
			\sa CSIBCRotMatd::Set
			\sa CSIBCRotMatd::SetRow
			\sa CSIBCRotMatd::SetCol
		...
		*/
		...
		/*!	Sets the rotation matrix to be a rotation about the major axis \p in_axis,
			...
			\param[in]	in_axis		The major axis for the rotation matrix.
			\param[in]	in_dAngle	Angle of rotation about the major axis, in radians.
			\return	Reference to this matrix.
		*/
		...
		*/
		...
		/*! Computes the matrix multiplication of this matrix and \p in_mat (<TT>this * in_mat</TT>)
			and stores the result in this matrix.
		...
		*/
		...
		/*! Computes the matrix multiplication of the transpose of \p in_mat1 and \p in_mat2
			(<TT>in_mat1^T * in_mat2</TT>) and stores the result in this matrix.
			\param[in]	in_mat1	The first matrix in the multiplication (on the left), to be
		...
		*/
		...
		/*! Computes the matrix multiplication of \p in_mat1 and the transpose of \p in_mat2
			(<TT>in_mat1 * in_mat2^T</TT>) and stores the result in this matrix.
			\param[in]	in_mat1	The first matrix in the multiplication (on the left).
			\param[in]	in_mat2	The second matrix in the multiplication (on the right), to be
				transposed before multiplication.
			\return	Reference to this matrix.
			\sa	CSIBCRotMatd::Mul
			\sa CSIBCRotMatd::MulTransByReg
		...
		*/
		...
		/*! Sets this matrix to the negative of \p in_mat. The \a negative of a matrix is produced
			by multiplying each element of the matrix by \c -1.
		...
		*/
		...
		/*! Sets this matrix to its negative. The \a negative of a matrix is produced
			by multiplying each element of the matrix by \c -1.
			\return	Reference to this matrix
