...
/*!
	\file SIBCUtil.h
	\brief Defines the CSIBCUtil class and the following defines:
		\li \link ftktutil_group Crosswalk SDK utility macros and defines \endlink
		\li \link mathdef_group Mathematical functions and constants \endlink
		\li \link siError_group Crosswalk SDK error codes \endlink
		\li \link sitype_group Softimage Crosswalk SDK type definitions \endlink
		\li \link vptypes_group Variant Parameter types \endlink
		\li \link vtwktypes_group Variant Parameter Tweak types \endlink
...
// Typedefs
//**************************************************************************************
/*!	\addtogroup	siError_group eSI_Error Enum
	Grouping of all Crosswalk SDK error codes used by SI_Error. If a value in this enumeration
	does not have a description, it indicates that this value is never returned from any function
	from within the Crosswalk SDK.

	\note Most of these error codes are unused in the Crosswalk SDK Semantic Layer. They are
		taken as a subset of Softimage errors, and used for compliance reasons.
	@{
*/
#ifndef _CUS_DLL
typedef enum {
	...
	SI_ERR_INTERNAL,			//!< Internal to the Crosswalk SDK.
...
/*!	\addtogroup mathdef_group Mathematical functions and constants
...
#ifndef NULL
#define NULL 0	/*! NULL is defined as zero. */
#endif
/*!	@}
*/

/*! \addtogroup sitype_group Softimage Crosswalk SDK Type Defines
	These defines show the mapping between built-in basic types, and the basic types
	used within the Crosswalk SDK.
	@{
*/
#define SI_Bool		unsigned short		/*!< Defined as 'unsigned short'. */
#define SI_Byte		char				/*!< Defined as 'char'. */
#define SI_UByte	unsigned char		/*!< Defined as 'unsigned char'. */
#define SI_Short	short				/*!< Defined as 'short'. */
#define SI_UShort	unsigned short		/*!< Defined as 'unsigned short'. */
#define SI_Int		int					/*!< Defined as 'int'. */
#define SI_UInt		unsigned int		/*!< Defined as 'unsigned int'. */
#define SI_Float	float				/*!< Defined as 'float'. */
#define SI_Double   double				/*!< Defined as 'double'. */
#define SI_Long		int					/*!< Defined as 'LONG'. */
#define SI_Void		void				/*!< Defined as 'void'. */
#define SI_ULong	unsigned int		/*!< Defined as 'ULONG'. */
typedef SI_Float	SI_Matrix[4][4];	/*!< Defined as a 4x4 array of SI_Float values. */
/*!	@}
*/
...
/*! \addtogroup vptypes_group Variant Parameter Type Defines
...
/*!
	\addtogroup  vtwktypes_group Variant Parameter Tweak Type Defines
...
/*!	\brief Holds variants for CdotXSIParam objects.
...
typedef TinyVariant SI_TinyVariant;	/*!< Alias for the TinyVariant structure used within CdotXSIParam objects. */
...
/*! \addtogroup ftktutil_group Crosswalk SDK Utilities
	This page lists the macros and defines available in the Crosswalk SDK.
	@{
*/
...
/*! Creates a new instance of \p y and assigns it to \p x, making sure it is not \c NULL. */
#define _SI_NEW(x,y) {	x = new y; _SI_ASSERT( x != NULL ); }

/*! Deletes \p ptr, if it is not \c NULL, and then assigns \p ptr to \c NULL. */
#define _SI_DELETE( ptr ) {	if ( ptr != NULL ) { delete ptr; ptr = NULL; }  }

/*! Deletes the array \p ptr, if it is not \c NULL, and then assigns \p ptr to \c NULL. */
...
/*! \brief Class used for utility functions.
...
public:
	...
	*/
	...
	/*! Opens the logfile given by \p in_pFilename
		\param[in]	in_pFilename	Filename of the logfile to open.
		\retval SI_Error::SI_SUCCESS The logfile was successfully opened.
		\sa CSIBCUtil::Close
	...
	*/
	...
	/*!	Closes the currently opened logfile.
		\retval SI_Error::SI_SUCCESS The file was closed successfully.
		\retval SI_Error::SI_ERR_ERROR_MSG An error occurred while closing the file.
		\sa CSIBCUtil::Open
	*/
	...
	*/
	...
	/*!	Prints a formatted string to the opened logfile. The format of this
		...
		\param[in]	...	Values for entries in the formatting string.
		\sa CSIBCUtil::Open
	*/
	...
	*/
	...
	/*!	Returns the cosine of \p x.
		\param[in]	x	The angle (in radians) to get the cosine value of.
	...
	*/
	...
	/*!	Returns the sine of \p x.
		\param[in]	x	The angle (in radians) to get the sine value of.
...
/*	Calculates the cosine of an angle.
	\param[in] x Angle
	\return Result of the cosine operation.
*/
...
/*	Calculates the sine of an angle.
	\param[in] x Angle
	\return Result of the sin operation.
*/
