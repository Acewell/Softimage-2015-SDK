...
/*!
	\file SIBCMath.h
	\brief Defines the \link mathdef_group Mathematical functions and constants \endlink
...
/*! Returns difference between two angles (between 0 and 'pi')
	\param[in]	angle1	The first angle (in radians).
	\param[in]	angle2	The second angle (in radians).
	\return	The angle between the two angles (in radians).
*/
...
/*! Returns the angle based on the value of the sine and cosine values given (between -'pi' and 'pi).
	\param[in]	sinus	The sine value of the angle.
	\param[in]	cosinus	The cosine value of the angle.
...
/*! Returns the inverse of the 3rd-order Bernstein polynomial, at value \p Param.
	\param[in]	Param	Value to at which the inverse is taken.
	\param[in]	x0		0th order Berstein polynomial coefficient.
	\param[in]	x1		1st order Berstein polynomial coefficient.
	\param[in]	x2		2nd order Berstein polynomial coefficient.
	\param[in]	x3		3rd order Berstein polynomial coefficient.
	\return	Inverse value of the Berstein polynomial at value \p Param.
*/
...
/*! Limits a value to a specified range.
	...
	\param[in]	a	The lower limit of the range.
	\param[in]	b	The upper limit of the range.
*/
