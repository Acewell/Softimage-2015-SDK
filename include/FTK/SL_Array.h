...
/*!
	\file SL_Array.h
	\brief Defines the CSLArrayProxy class
...
/*! \brief Proxy class that allows the manipulation of an array parameter in a template.

	\param[in] CElemType Element type contained in the array.
	\param[in] CSubElemType Sub element type composing the \p CElemType.  Can be the same as \p CElemType if \p StructSize equals one.
	\param[in] StructSize Number of \p CSubElemType that composes a single \p CElemType.
...
public:
	/*! Constructor. Connects to an array parameter in the parent template.
		...
		\param[in] in_Index Index of the array paramater in the template
	 */
	...
	*/
	...
	/*! Connects to an array parameter in the parent template.
		\param[in] in_pTemplate Pointer to the parent template
		\param[in] in_lArrayIndex Index of the array in the template
	...
	*/
	...
	/*! Adds a specific number of used cells to the array as required
		\param[in] in_lNbElem Number of cells to add
	...
	*/
	...
	/*! Adds used cells to the array as required.
		...
		\param[in]	in_lNewNbElem Number of cells to add
		\return The number of used cells
	...
	*/
	...
	/*! Extends the number of used cells by a substantial amount if there's
		...
		\param[in] in_lNbElem The number of additional used cells to add
		\return The number of used cells
	...
	*/
	...
	/*! Inserts an exact number of used cells at the provided index
		\note Enough used cells are going to be added to the array if it
			...
			<BR><BR>
			The array will only be increased by the number of missing used
			cells slots.  If you expect a lot of insertion, you should
			consider calling CSLArrayProxy::Resize or CSLArrayProxy::Extend
			before using this function in order to improve performance.

		\param[in] in_lIndex Insertion point
		\param[in] in_lNbElem Number of used cells to add
		\return The number of used cells
	...
	*/
	...
	/*! Deletes a given number of element at a the specified index
		\param[in] in_lIndex	The index of the element where deletion must start
		\param[in] in_lNbElem	The number of elements to delete (must be positive)
	*/
	...
	*/
	...
	/*! Deallocates unused cells
		\param[in] i_lMaxWasted Maximum number of allowed unused cells
		\return The number of used cells
	...
	*/
	...
	/*! Copy data from another array
		\param[in] in_rSrcObject	The array to copy data from
		\return	The number of used cells
	...
	*/
	inline CElemType* ArrayPtr();

	/*! Sets values in a given range
		\param[in] start		The index of first element to set
		\param[in] in_lNbElem	The number of elements to set
		\param[in] value		New value for the elements in the given range.
	*/
...
/*! \internal Increases the size of the referred array as required.  Will allocate
	...
	\param[in] in_lNewSize Elements to add
	\param[in] in_lExpandRatio Element multiplier when there's not enough memory
