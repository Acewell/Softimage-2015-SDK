...
/*!
	\file CustomParamInfo.h
	\brief Defines the CSLXSICustomParamInfo class
...
/*! \brief This class represents the \xx ftk_XSI_CustomParamInfo XSI_CustomParamInfo \endxx template.

	Provides additional information concerning a specific parameter in a CSLCustomPSet
	(see the \xx ftk_XSI_CustomParamInfo XSI_CustomParamInfo \endxx template reference).

	The CSLXSICustomParamInfo class enhances the usability of the CSLCustomPSet
...
public:
	/*! Definition of all possible parameter capabilies flags.
		...
		\eg Mask of Animatable + Persistable
		\code
	...
	*/
	...
	/*! Constructor
		...
		\param[in] in_pParameter Parameter whose definition is enhanced
	*/
	...
	/*! Returns the type of this template
		\return CSLTemplate::XSI_CUSTOM_PARAM_INFO Template type
	*/
	ETemplateType Type(){ return XSI_CUSTOM_PARAM_INFO; }

	/*! Returns the minimum value
		\param[out] out_Value The minimum value
		\retval SI_Error::SI_SUCCESS Got the minimum value
		\retval SI_Error::SI_ERR_BAD_ARGUMENT The variant type of \p out_Value does not match the type of the minimum value.
	*/
	...
	*/
	...
	/*! Sets the minimum value
		\param[in] in_Value The minimum value
		\retval SI_Error::SI_SUCCESS The value was set
		\retval SI_Error::SI_ERR_BAD_ARGUMENT The variant type of \p in_Value does not match the type of the minimum value.
	*/
	...
	*/
	...
	/*! Returns the maximum value
		\param[out] out_Value The maximum value of the parameter
		\retval SI_Error::SI_SUCCESS Got the maximum value
		\retval SI_Error::SI_ERR_BAD_ARGUMENT The variant type of \p out_Value does not match the type of the minimum value.
	*/
	...
	*/
	...
	/*! Sets the maximum value
		\param[in] in_Value The maximum value
		\retval SI_Error::SI_SUCCESS The value was set
		\retval SI_Error::SI_ERR_BAD_ARGUMENT The variant type of \p in_Value does not match the type of the minimum value.
	*/
	...
	*/
	...
	/*! Sets the Capabilities flag value.
		\param[in] in_ulValue  New capabilities flags
