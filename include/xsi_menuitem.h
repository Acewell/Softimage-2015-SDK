...
public:
	...
	*/
	...
	/*! Sets the filter for this menu item. %XSI uses the filter for validating the menu item or an entire menu
	...
	*/
	...
	\param in_bFlag True checks the menu item, false unchecks it.
	\return CStatus::OK Success.
	\return CStatus::Fail Failure.
	\since 10.0 (2012)
	*/
