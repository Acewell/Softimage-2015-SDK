...
public:
	...
	*/
	...
	\param in_time time value in the format units.
	...
	*/
	...
	\param in_time			time in units specified by in_units
	\param in_units			units for input time
	\param in_format		time format
	\param in_customrate	frames per seconds for custom frame rate format
	*/
	...
	*/
	...
	\param in_units One of the CTime::Unit enum values
	...
	*/
	...
	\param in_time Time to set. By default time is set in frames
	\param units One of the CTime::Unit enum values
	*/
	...
	*/
	...
	\param in_format One of the CTime::Format enum values
	\param in_customrate Frames per second for custom frame rate format
	*/
	...
	*/
	...
	\return The newly created CTime object.
	*/
