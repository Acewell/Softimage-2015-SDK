//*****************************************************************************
/*!
   \file xsi_icedataprovidernode.h
   \brief ICEDataProviderNode class declaration.
...
#ifndef __XSIICEDATAPROVIDERNODE_H__
#define __XSIICEDATAPROVIDERNODE_H__
...
//*****************************************************************************
/*! \class ICEDataProviderNode xsi_icedataprovidernode.h
	\brief The ICEDataProviderNode object represents a \xl GetDataNode in an ICE graph.

	The responsibility of an %ICEDataProviderNode is to to read the data from Softimage
	objects and is typically used to initiate the data flow of the graph.

	\sa ICEDataModifierNode
	\since 7.0

	\eg This example demonstrates how to log all the data provider nodes in a graph.
	\code
...
class SICPPSDKDECL ICEDataProviderNode : public ICENode
{
public:
	/*! Default constructor. */
	ICEDataProviderNode();
	...
	*/
	...
	\param in_obj constant class object.
	\return The new ICEDataProviderNode object.
	*/
	...
	*/
	...
	private:
	ICEDataProviderNode * operator&() const;
	ICEDataProviderNode * operator&();
};

};

#endif // __XSIICEDATAPROVIDERNODE_H__
