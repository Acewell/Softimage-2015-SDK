 ...
 * ufoProcessSetSuggestedParamLimits():     Set suggested parameter limits
 ...
 *    Sets the HTML help file and index which will pop up if the help (?) button 
 *    on the PPG is clicked.
 ******************************************************************************/
UFOAPI  
void ufoProcessSetHelpInfo(
	ufoProcess		process_instance,			/*process instance handle  */	
	char *			pszFile );				   /* html help file name */
...
/*******************************************************************************
 * ufoProcessSetSuggestedParamLimits():
 *    Set suggested limits for parameter.
 * 
 *    - SHOULD be called within ufoProcessDefine() after ufoProcessParamDefine()
 ******************************************************************************/
UFOAPI  
void ufoProcessSetSuggestedParamLimits(
    ufoProcess      process_instance,           /*process instance handle*/

    int             param_index,                /*index (0..number_parameters) of parameter*/
    ufoChannelIndex channel_index,              /*index into particular channel (eg. ufoColourRGBChannelIndexR*/
                                                /*for parameter of type ufoColourRGBParam*/
    double          suggested_minimum,          /*suggested minimum limit*/
    double          suggested_maximum);         /*suggested maximum limit*/
