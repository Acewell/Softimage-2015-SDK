...
public:
	...
	*/
	...
	with the deprecated \a CreateParticleCloud command unless the cloud is frozen.
	...
	*/
	...
	/* Obsolete function to add particles to a cloud.
	\deprecated 4.0 Maintained for backward compatibility only.
	\param in_NbParticles Number of new particles to add.
	\param in_ParType Reference to an existing particle type object.
	*/
	...
	*/
	...
	type is created automatically when the deprecated \a CreateParticleCloud command is called.
	A particle type can also be created by calling the deprecated \a CreateParticleType command
	and associated with a cloud when X3DObject::AddParticleCloud is called.
	\sa ParticleType
	*/
