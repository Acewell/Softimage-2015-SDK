...
public:
	...
	*/
	...
	the Parameter containing the Source (the audio or image file, etc).
	...
	*/
	...
	When rendering to disk, Softimage creates file sequences based on a base filename that you provide in the \a Render
	\a Options property page and when browsing the output folder, Softimage displays file sequences as a single entity
	with an annotation like: \c myfile[1..2].pic.
