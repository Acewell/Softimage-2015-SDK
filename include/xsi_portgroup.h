...
public:
	...
	*/
	...
	\deprecated 5.1 This method is obsolete and must not be used. Use CustomOperator::AddInputPort instead.
	...
	*/
	...
	\deprecated 5.1 This method is obsolete and must not be used. Use CustomOperator::AddOutputPort instead.
	\param  target Object to be connected to the port.
	\param  name Port name.
	\param  insertat %Port index within group.
	...
	*/
	...
	/*! Adds output port to operator port group. The port is assumed to be mandatory.
	\deprecated 5.1 This method is obsolete and must not be used. Use CustomOperator::AddIOPort instead.
	\param  target Object to be connected to the port.
	\param  name Port name.
	\param  insertat %Port index within group.
